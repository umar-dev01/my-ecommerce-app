...
function Hero() {
  ...
  return (
    <section className="bg-hlight min-h-[600px] flex item-center px-8 py-16">
      <div className="container mx-auto flex flex-col lg:flex-row item-center justify-center relative">
        <div className="lg:w-1/2">
          <p className=" text-hpink font-lato text-lg mb-2">
            Best Furniture for your Castle...
          </p>
          <h1 className=" font-josefin text-5xl lg:text-6xl font-bold text-hdark leading-tight mb-6">
            New Furniture <br />
            Collection <br />
            Trends in 2026
          </h1>
